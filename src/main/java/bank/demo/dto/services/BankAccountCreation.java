...
public class BankAccountCreation {
    ...
    public BankAccountCreation(List<RuleFirstNameAndLastName> ruleFirstNameAndLastName, SessionFactory sessionFactory) {
...
//
//
//    void createBankAccount(ListBankAccount bankAccountList, Users1 user, CreditCard creditCard, int idUser) {
//
...
//    }
//
//    public Users1 createUser(String firstName, String lastName, int age, TypeOfBenefits typeOfBenefits) {
//        Users1 user = new Users1(firstName, lastName, age, typeOfBenefits);
//        return user;
//    }
//
